    ...
    public static ArrayList<EarthquakeReport> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i < earthquakearray.length(); i++){
                ...
                EarthquakeReport mEarthquakeReport = new EarthquakeReport(magnitude, location, time);
                earthquakes.add(mEarthquakeReport);
